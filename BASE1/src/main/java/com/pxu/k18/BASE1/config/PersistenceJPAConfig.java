package com.pxu.k18.BASE1.config;
...
@ComponentScan("com.pxu.k18.BASE1")
@EnableJpaRepositories(basePackages = "com.pxu.k18.BASE1.repository")
...
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[]{"com.pxu.k18.BASE1.entity"});
